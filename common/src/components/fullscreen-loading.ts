...
export class FullscreenLoading extends HTMLElement {
  static tagName: string;
  static style: string;
  static SVGHtml: string;
  static template: HTMLTemplateElement;
  static define() {
    if (!window.customElements.get(FullscreenLoading.tagName)) {
      window.customElements.define(FullscreenLoading.tagName, FullscreenLoading);
    }
  }
...
FullscreenLoading.tagName = 'fullscreen-loading';
...
FullscreenLoading.template = h('template', null, [
  ...
  h('div', { className: 'fullscreen-loading_container' }, [
    h('div', { className: 'fullscreen-loading__content' }, [
      ...
      h('p', { className: 'fullscreen-loading__text' }, [h('slot', null, 'Wecome to Laboratory')])
    ])
  ])
]);

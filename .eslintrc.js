...
module.exports = {
  ...
  "rules": {
    ...
    "react/jsx-indent-props": ["error", "error"], // 验证JSX中的props缩进
    "react/jsx-key": "error", // 在数组或迭代器中验证JSX具有key属性
    "react/jsx-max-props-per-line": ["warn", {"maximum": "error"}], // 限制JSX中单行上的props的最大数量
    ...
    "react/jsx-sort-props": "warn", // 强化props按字母排序
    ...
    "no-unused-vars": ["warn", {"vars": "all", "args": "none"}], // 不能有声明后未被使用的变量或参数

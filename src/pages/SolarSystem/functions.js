...
function DrawGrid(t, n, e, o) {
  ...
  for (let r = e + .5; r < t.canvas.width; r += e) t.beginPath(), t.moveTo(r, 0), t.lineTo(r, t.canvas.height), t.stroke();
  for (let r = o + .5; r < t.canvas.height; r += o) t.beginPath(), t.moveTo(0, r), t.lineTo(t.canvas.width, r), t.stroke();
  t.restore()
}
...
let Color = {
    ...
    hslToRgb: function (t) {
      ...
      for (let r = o >= .5 ? o + e - o * e : o * (1 + e), a = 2 * o - r, i = [1 / 3, 0, -1 / 3], u = 0; u < 3; u++) {
        let s = n + i[u];
  ...
  Tween = {
    linear: function (t, n, e, o) {
      ...
      if (a || (a = .3 * o), !r || r < Math.abs(e)) {
        r = e;
        let i = a / 4
      } else let i = a / (2 * Math.PI) * Math.asin(e / r);
